          ...
          <div className="h-16 px-4 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-10 h-10 flex items-center justify-center rounded-xl text-[#131b2e] hover:bg-[#e2e7ff] transition-colors"
              >
          ...
          <div className="flex flex-col w-full px-1 space-y-6">
            ...
            <div className="flex flex-col gap-1 mt-2">
              ...
              <div className="flex items-baseline justify-between mt-1">
                <h2 className="text-xl font-bold text-[#131b2e]">Appointments &amp; Tour Schedule</h2>
              </div>
