...
function AppIssuesView() {
  const { t } = useLanguage();
  return (
    <div className="min-h-screen bg-[#f8f6ff] pb-28 font-['Plus_Jakarta_Sans'] text-[#17111c]">
      <main className="px-5 pt-4">
        <div className="mb-6 flex items-start justify-between gap-3">
          <div>
            <h1 className="text-[23px] font-bold leading-7 tracking-tight">{t('issues.title')}</h1>
